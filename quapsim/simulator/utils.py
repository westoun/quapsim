...
class InvertedGateFrequencyDict:
    ...
    def add(self, frequency: int, gate: IGate) -> "InvertedGateFrequencyDict":
...
def calculate_gate_sequence_frequecy(
        ...
        for document_candidate in document_candidates:
            ...
            left_pred_occurrences = inverted_index.get_locations(gate_sequence[0], document_candidate)

            for succ_word in gate_sequence[1:]:
                succ_occurrences = inverted_index.get_locations(succ_word, document_candidate)
