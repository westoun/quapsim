...
if __name__ == "__main__":
    ...
    run_result_benchmark(
        quasim=quasim, quapsim=quapsim, qubit_num=4, circuit_count=1000
    )
    ...
    run_time_benchmark_quasim_quapsim(
        quasim=quasim, quapsim=quapsim, qubit_num=4, circuit_count=4000
    )
    ...
    run_time_benchmark_quapsim_quapsim(
        quapsim1=quapsim1, quapsim2=quapsim2, qubit_num=4, circuit_count=4000
    )
